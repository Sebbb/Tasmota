...
enum {
  ...
  HUE_LIGHTS_STATUS_JSON2=35,
  HUE_GROUP0_STATUS_JSON=116,
  HUE_ERROR_JSON=179,
  HUE_RESP_ON=249,
  HUE_RESP_NUM=288,
  HUE_RESP_XY=327,
...
// Compressed from 371 to 249, -32.9%
const char HUE_LIGHTS[] PROGMEM = "\x00\x18\x3E\xBC\x7B\x2C\x27\xFA\x3D\x87\x99\xEC\xEC\xE6\x7B\x0E\xA3\xD9\xF7\x61"
                             "\x8A\xB1\xC1\x33\xD8\x79\xD7\xC5\xB3\xDD\x38\x5F\x3A\x8F\x65\x19\x0C\x67\xB0\xF3"
                             "\x3D\x87\xD7\x8F\x61\xD4\x7B\x3A\xC6\x82\x24\x81\xB8\x23\x0B\x44\x04\x49\x77\xC2"
                             "\xCC\x58\x74\x2F\xEF\xE0\x8F\x81\x8B\xED\x35\x0B\x60\x87\x82\x1E\xE9\xC2\xF9\xED"
                             "\x04\x3C\x84\x87\xBF\x82\xC6\x23\x8C\xF6\x1D\x47\xB0\x82\xD1\xE1\x55\xE3\xD8\x79"
                             "\x9E\xF1\xED\x08\xE4\x3D\xF2\x04\x4D\x34\x82\xD1\xE1\x54\x43\xDF\xC1\x63\x0F\x61"
                             "\xD4\x7B\x2C\x3A\xDC\xE3\xD8\x79\xCE\x17\xCF\x78\xF6\x9E\xC7\xFF\xE7\xCF\x61\xE6"
                             "\x7B\x41\x0B\x05\x38\x9C\x3A\x8F\x61\x58\x82\x7D\xFB\xC7\xB0\xF3\x3D\x87\x61\xEC"
                             "\x3A\x8F\x60\x8F\xC1\xFF\x46\x02\x0E\x1E\x7B\x0B\x7A\x9F\xFA\xC2\x44\xFF\xFC\xF9"
                             "\xEC\x3D\xC7\xB8\xF7\xE7\x0B\xE7\xB4\xF6\x78\x58\x61\xBF\x78\xF6\x1E\x67\xB4\xF6"
                             "\x1D\x80\x83\xAE\x1D\x87\xD0\x87\x67\xAA\xE9\x9D\x99\xC7\xB0\xF3\x3E\xBC\x7B\x8F"
                             "\x70\x2D\x60\x67\xD7\x8F\x61\xE6\x7D\x08\x0B\x98\x19\xB0\xC8\xF6\x1E\x67\xBC\x7D"
                             "\x78\xEA\x3E\xBC\x7B\xE7\xB8\xF7\x4E\x17\xCD";
// ++++++++++++++++++++^^^^^^^^^^^^^^^^^^^++++++++++++++++++++
// ++++++++++++++++++++ DO NOT EDIT ABOVE ++++++++++++++++++++
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
